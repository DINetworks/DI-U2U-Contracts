...
Meta transactions enable gasless user experiences by allowing relayers to pay transaction fees on behalf of users. This guide covers the IU2U Protocol's meta-transaction implementation, use cases, and integration patterns.
...
contract MetaTxGateway is EIP712 {
    ...
    constructor() EIP712("IU2U Meta Transaction", "1") {}
