...
contract CrossChainBridge is IExecutable {
    ...
    function bridgeTokens(
        ...
        IIU2UGateway.TransferParams memory params = IIU2UGateway.TransferParams({
...
describe("IU2U Smart Contract Integration", function () {
  ...
  beforeEach(async function () {
    ...
    const Gateway = await ethers.getContractFactory("MockIU2UGateway");
...
async function main() {
  ...
  const networkAddresses = {
    mainnet: {
      gateway: "0x...", // IU2U Gateway address on mainnet
...
contract SecureIU2UIntegration is Ownable, Pausable {
...
contract SafeIU2UIntegration is ReentrancyGuard {
...
- [IU2U API Reference](../api-reference/)
