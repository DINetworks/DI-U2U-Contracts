...
describe("CrossChainAggregator", function () {
    ...
    beforeEach(async function () {
        ...
        iu2uToken = await MockERC20.deploy("IU2U Token", "IU2U", 18);
        ...
        await iu2uToken.mint(crossChainAggregator.address, ethers.utils.parseEther("10000"));
    ...
    describe("Deployment", function () {
        ...
        it("Should set the correct IU2U token address", async function () {
            expect(await crossChainAggregator.iu2uToken()).to.equal(iu2uToken.address);
        });
    ...
    describe("Cross-Chain Swap", function () {
        ...
        it("Should handle IU2U token as source correctly", async function () {
            validSwapData.sourceToken = iu2uToken.address;
            
            await iu2uToken.connect(user1).approve(crossChainAggregator.address, validSwapData.sourceAmount);
    ...
    describe("Emergency Functions", function () {
        it("Should allow owner to emergency withdraw", async function () {
            ...
            await expect(
                crossChainAggregator.connect(owner).emergencyWithdraw(iu2uToken.address, amount)
            ).to.not.be.reverted;
        });
        ...
        it("Should not allow non-owner to emergency withdraw", async function () {
            ...
            await expect(
                crossChainAggregator.connect(user1).emergencyWithdraw(iu2uToken.address, amount)
            ).to.be.revertedWith("Ownable: caller is not the owner");
        });
    });
    ...
    describe("SwapCalldataGenerator", function () {
        ...
        it("Should generate Uniswap V2 calldata correctly", async function () {
            const calldata = await swapCalldataGenerator.generateUniswapV2Calldata(
                ...
                [iu2uToken.address, mockToken.address],
                user1.address,
        ...
        it("Should generate Uniswap V3 calldata correctly", async function () {
            const path = ethers.utils.solidityPack(
                ...
                [iu2uToken.address, 3000, mockToken.address]
            );
    ...
    describe("Integration Tests", function () {
        it("Should complete full swap flow with calldata generation", async function () {
            ...
            const calldata = await swapCalldataGenerator.generateUniswapV2Calldata(
                ...
                [mockToken.address, iu2uToken.address],
